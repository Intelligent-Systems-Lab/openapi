...
/*
DefaultApiService Nupf_EventExposure UnSubscribe service Operation
...
func (a *DefaultApiService) DeleteSubscription(
	ctx context.Context,
...
/*
DefaultApiService Nupf_EventExposure Subscribe Modify service Operation
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
func (a *DefaultApiService) ModifySubscription(
	ctx context.Context,
