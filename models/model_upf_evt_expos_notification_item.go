...
type Upf_EvtExpos_NotificationItem struct {
	...
	UserDataUsageMeasurements []Upf_EvtExpos_UserDataUsageMeasurements `json:"userDataUsageMeasurements,omitempty" yaml:"userDataUsageMeasurements,omitempty" bson:"userDataUsageMeasurements,omitempty"`
}
